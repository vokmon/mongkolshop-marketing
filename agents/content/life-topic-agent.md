...
2. เขียน content ใน **3 ส่วน**:
   - **Hook** — ประโยคแรกต้องทำให้คนหยุด เป็นคำถาม สถานการณ์ที่ relate หรือข้อเท็จจริงที่น่าสนใจ (ไม่เริ่มด้วย "สวัสดี")
...
- **Emoji**: ใช้เบาๆ 2-4 ตัวต่อ post — วางที่จุดเปลี่ยน insight สำคัญ หรือท้าย hook ไม่ใช่ทุกบรรทัด ห้ามใช้เพื่อตกแต่งอย่างเดียว
